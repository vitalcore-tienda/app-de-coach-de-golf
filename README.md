...
La migración lista para aplicar está en [`database/supabase/migrations/202608210001_secure_coach_platform.sql`](database/supabase/migrations/202608210001_secure_coach_platform.sql). Antes de activar la sincronización cloud hay que aplicar esa migración en el proyecto de Supabase y configurar la URL de retorno de GitHub Pages en Auth. No subas nombres, teléfonos, correos ni claves de jugadores al repositorio: GitHub Pages es público.
